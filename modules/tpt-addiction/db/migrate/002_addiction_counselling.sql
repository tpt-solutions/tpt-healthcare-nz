-- 002_addiction_counselling.sql
-- Addiction-specific counselling sessions, group sessions, treatment plans, goals, and relapse events.
...
CREATE INDEX idx_addiction_sessions_patient ON addiction_counselling_sessions(tenant_id, patient_nhi, session_date DESC);
CREATE INDEX idx_addiction_sessions_clinician ON addiction_counselling_sessions(tenant_id, clinician_id, session_date DESC);
...
CREATE INDEX idx_addiction_group_scheduled ON addiction_group_sessions(tenant_id, scheduled_at DESC);
...
-- Treatment plans (linked to a programme optionally).
...
CREATE INDEX idx_addiction_plans_patient ON addiction_treatment_plans(tenant_id, patient_nhi);
...
CREATE INDEX idx_addiction_goals_plan ON addiction_goals(tenant_id, plan_id);
...
CREATE INDEX idx_addiction_relapses_plan ON addiction_relapses(tenant_id, plan_id, occurred_at DESC);
