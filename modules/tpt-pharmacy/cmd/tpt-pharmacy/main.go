...
import (
	...
	"github.com/PhillipC05/tpt-healthcare/modules/tpt-pharmacy/api"
...
func newRootCmd() *cobra.Command {
	root := &cobra.Command{
		Use:   "tpt-pharmacy",
		Short: "TPT Pharmacy service — dispensing, PHARMAC claiming, and inventory management",
	}
...
func newServeCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "serve",
		Short: "Start the tpt-pharmacy HTTP server",
	...
	cmd.Flags().IntVar(&port, "port", 8082, "Port to listen on")
