...
import (
	...
	"github.com/PhillipC05/tpt-healthcare/modules/tpt-immunisation/api"
...
func newRootCmd() *cobra.Command {
	root := &cobra.Command{
		Use:   "tpt-immunisation",
		Short: "TPT Immunisation service — recording, NIR integration, and schedule management",
	}
...
func newServeCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "serve",
		Short: "Start the tpt-immunisation HTTP server",
	...
	cmd.Flags().IntVar(&port, "port", 8083, "Port to listen on")
